...
<!--发帖弹出窗口-->
<div class="modal fade" id="register" role="dialog" aria-labelledby="gridSystemModalLabel">
    <div class="modal-dialog" role="document" >
        <div class="modal-content" >
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="gridSystemModalLabel">注 册</h4>
            </div>
                ...
                <div class="container-fluid">
                    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/register">
                        ...
                        <div class="modal-footer">
                            ...
                            <%--<a href="#">--%>
                            <button type="submit" class="btn btn-xs btn-green">注 册</button>
                            <%--</a>--%>
                        </div>
                    </form>
                </div>
